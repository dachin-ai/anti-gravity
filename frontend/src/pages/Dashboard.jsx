...
const TOOLS_CATALOG = [
    ...
    { name: "Order Failed Delivery", desc: "Tracking and resolving failed delivery orders.", main_user: "Platform Responsible", platform: "TikTok", icon: "🚚", path: "/failed-delivery", active: false, category: "operations" },
    { name: "Pre-Sales Estimation", desc: "Volume estimation and forecasting for pre-sales events.", main_user: "Account Responsible", platform: "TikTok", icon: "🔮", path: "/pre-sales", active: false, category: "planning" },
    { name: "New ERP OOS Calculate", desc: "Out of Stock (OOS) calculation based on new ERP data.", main_user: "Customer Service", platform: "ERP Qianyi", icon: "⚡", path: "/erp-oos", active: false, category: "operations" },
